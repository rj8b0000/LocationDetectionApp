...
const LoginScreen = ({navigation}) => {
  ...
  const storeUser = async (user, token) => {
    try {
      ...
      console.log('User and token stored in AsyncStorage:', {user, token});
    } catch (error) {
      ...
      Alert.alert('Success', response.data.message, [
        {
          text: 'OK',
          onPress: () =>
            navigation.replace('BottomNavigator', {user: response.data.user}),
        },
      ]);
    } catch (error) {
          ...
          <View style={styles.content}>
            ...
            {activeTab === 'Login' ? (
              ...
              <Button
                ...
                style={styles.actionButton}
                labelStyle={styles.actionButtonText}
                disabled={loading || !fullName || !mobileNumber || !password}
                loading={loading}>
                Register
              </Button>
            )}
